...
FIXTURE_FINGERPRINT = (
    "sha256:50e2947be8955c0a11f8f51760db13d6f9602e5b4d9d7cb29eedacb8a05568a1"
)
...
FIELD_DEFINITIONS: dict[str, dict[str, Any]] = {
    name: vocabulary.field_descriptor(name) for name in vocabulary.official_field_names()
}
