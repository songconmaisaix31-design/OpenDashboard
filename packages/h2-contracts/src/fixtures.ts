...
export const H2_FIXTURE_DATASET = {
  ...
  fields: [
    ...
    {
      name: 'bess_power_actual_kw',
      displayNameZh: '储能实际功率',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
    {
      name: 'pcc_power_actual_kw',
      displayNameZh: 'PCC实际有功功率',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
    {
      name: 'elz1_power_actual_kw',
      displayNameZh: '1号电解槽实际功率',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
    {
      name: 'elz2_power_actual_kw',
      displayNameZh: '2号电解槽实际功率',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
    {
      name: 'elz3_power_actual_kw',
      displayNameZh: '3号电解槽实际功率',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
    ...
    {
      name: 'bess_soc_pct',
      displayNameZh: '储能实际SOC',
      role: 'measurement',
      required: true,
      unit: '%',
    },
    {
      name: 'grid_export_power_limit_kw',
      displayNameZh: '上网功率上限',
      role: 'constraint',
      required: true,
      unit: 'kW',
    },
    {
      name: 'grid_import_power_limit_kw',
      displayNameZh: '下网功率上限',
      role: 'constraint',
      required: true,
      unit: 'kW',
    },
    {
      name: 'bess_power_cmd_kw',
      displayNameZh: '储能功率指令',
      role: 'measurement',
      required: true,
      unit: 'kW',
    },
